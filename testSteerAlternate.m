function[nav_score, max_val] = testSteerAlternate(p, K, v0, delta_offset,x0, y0, delta0,phi0, phi_dot0, psi0,lag1, lag2, nonlinear, a,Km, visual)
%Written by Dylan Meehan (dem292), S18
%Test given controllers given a vector of commanded steer angles
%identical to testSteerOffset, but notes maximal angle reached
